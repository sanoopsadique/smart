...
if __name__ == '__main__': 
    ...
    for client in statusMon:
        ...
        webport = str(int(client[1])+1000)
        writeWeb('Status monitoring server container for client at '+client[0]+ ' started. <a href=":'+webport+'\" target=_blank> Click here to view status</a>\n')
    ...
    for client in honeyPots:
        ...
        webport = str(int(client[1])+1000)
        writeWeb('Honeypot server container for client at '+client[0]+ ' started. <a href=":'+webport+'\" target=_blank> Click here to view status</a>\n')
